...
<main class="page">
    ...
    <Newspaper pageNumber="2">
        ...
        <img src={katukuva} class="newspaper-image" alt="Pimeä katu ja vilahtava peikon häntä" />
    </Newspaper>
    ...
    <Newspaper pageNumber="3">
        ...
        <img src={eetos} class="newspaper-image" alt="Etsivä toimistossaan" />
    </Newspaper>
    ...
    <Newspaper pageNumber="4">
        ...
        <img src={tyrsky} class="newspaper-image" alt="Kapteeni tähystää kaukoputkella" />
    </Newspaper>
</main>
